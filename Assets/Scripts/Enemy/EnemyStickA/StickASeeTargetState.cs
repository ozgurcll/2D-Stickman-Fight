...
public class StickASeeTargetState : EnemyState
{
    private Transform player;
    private int moveDir;
    protected EnemyStickA enemy;
    public StickASeeTargetState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, EnemyStickA _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
