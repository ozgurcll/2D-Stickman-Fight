...
public class StickAHurtState : EnemyState
{
    Player player;
    private int x = 0;
    ...
    public StickAHurtState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, EnemyStickA _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
